...
import { appointmentDeleteApi, appointmentListApi, appointmentUpdateApi } from '../services/Api'

function AppointmentList({setAppointmentId}) {
    ...
    async function handleDelete(id){
        ...
        let response=await appointmentDeleteApi(id)
    ...
    async function handleUpdate(data,id){
        ...
        let response=await appointmentUpdateApi(data,id)
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex space-x-2">
                            <button onClick={()=>setAppointmentId(a.id)} class="p-2 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all duration-200">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                            </button>
                            <button onClick={()=>handleDelete(a.id)} class="p-2 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
